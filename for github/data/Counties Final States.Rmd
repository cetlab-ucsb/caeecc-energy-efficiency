...
```{r}
counties_percap_x_lm2<-lm(ln_budget_per_cap_x~TotalRevenue+IRR+Mean.Income+ces_score_median, data=counties_x)
...
```{r}
counties_percapkwh_lm_x2<-lm(ln_kwh_per_cap_x~TotalRevenue+IRR+Mean.Income+ces_score_median, data=counties_x)
```
