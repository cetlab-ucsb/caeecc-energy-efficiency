...
K12_to_plot <- K12[!(K12$county %in% c("LOS ANGELES")),] 
...
```{r, counties spatial}
#the county names don't match (our data has capitalized first letters County =/= county), so we have to change it
counties_to_include = counties[!(counties$county %in% c("LOS ANGELES", "SAN DIEGO", "SAN FRANCISCO")),]
...
ggsave(file = "maps_local_govt_county_analysis.png", g)
```
