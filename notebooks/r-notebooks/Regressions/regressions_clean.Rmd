...
#testing these variables: lcff_scaled + lcffperstudent + irr + dac + obf + resource + income + perc_eligible_frpm + perc_title1 + population_scaled

#performs stepwise model selection by AIC for budget
stepAIC(lm(ln_budgetperstudent ~ lcff_scaled + lcffperstudent_scaled + irr + dac + obf + resource + income_scaled + perc_eligible_frpm + perc_title1, data = K12_x))
...
stepAIC(lm(ln_kWh ~ lcff_scaled + lcffperstudent_scaled + irr + dac + obf + resource + income_scaled + perc_eligible_frpm + perc_title1, data = K12_x))
...
#performs stepwise model selection by AIC for budget
stepAIC(lm(ln_budgetpercapita ~ revenue_scaled + revpercapita_scaled + dac + irr + population_scaled + obf + resource + income_scaled, data = counties_x))

#result testing all of them: ln_budgetpercapita ~ revpercapita_scaled + population_scaled + obf, data = counties_x
#result testing all of them: ln_budget ~ revenue_scaled + revpercapita_scaled + irr + population_scaled + obf, data = counties_x
```

```{r, County Step AIC selection}

#performs stepwise model selection by AIC for kWh
stepAIC(lm(ln_kWhpercapita ~ revenue_scaled + revpercapita_scaled + dac + irr + population_scaled + obf + resource + income_scaled, data = counties_x))

#result testing all of them: ln_kWhpercapita ~ revpercapita_scaled + irr + population_scaled, data = counties_x
#result testing all of them: ln_kWh ~ revenue_scaled + revpercapita_scaled + irr + population_scaled, data = counties_x
```
...
stepAIC(lm(ln_budgetpercapita ~ revenue_scaled + revpercapita_scaled + ruca + dac + population_scaled + obf + income_scaled + resource, data = cities_x))

#lm(formula = ln_budget ~ revenue_scaled + obf + resource, data = cities_x)
#lm(formula = ln_budgetpercapita ~ revenue_scaled + revpercapita_scaled + ruca + population_scaled + obf + resource, data = cities_x)
```

```{r, City Step AIC selection}

#performs stepwise model selection by AIC for kWh
stepAIC(lm(ln_kWhpercapita ~ revenue_scaled + revpercapita_scaled + ruca + dac + population_scaled + obf + income_scaled + resource, data = cities_x))

#result testing all of them: roundedkWhper ~ revpercapita + ruca + dac + obf + income, data = cities_x)
#lm(formula = ln_kWh ~ revenue_scaled + obf, data = cities_x)
#lm(formula = ln_kWhpercapita ~ revenue_scaled + ruca + dac + population_scaled + obf, data = cities_x)
```
...
cities.4 <- glm(ln_budget ~ revenue_scaled + ruca + dac + obf + income_scaled + resource, data = cities_x) #intuitive picks
...
cities.3 <- glm(ln_kWh ~ revpercapita_scaled + ruca + dac + obf + income_scaled + resource, data = cities_x) #intuitive picks
