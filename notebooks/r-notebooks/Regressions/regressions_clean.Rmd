...
>>>>>>> 98a7956963b1883ec3a935a9b6213d4a763a9bdf
...
<<<<<<< HEAD
counties.2 <- glm(ln_budget ~  irr, data = counties_x)
summary(counties.2) #Step AIC picks
...
<<<<<<< HEAD
counties.1 <- glm(ln_kWh ~  irr + population, data = counties_x)
...
stargazer(counties.2, counties.4, counties.6, counties.8, type="html", out= "tablecounty1.htm", title="Budget Regression Results (County)", align=TRUE, dep.var.labels=c("Log of Budget", "Log Budget Per Capita"), order=c("revenue_scaled", "revpercapita_scaled", "income_scaled", "irr", "dac", "obf", "population_scaled"), covariate.labels=c("Revenue (Scaled by 100000)", "Revenue per capita (Scaled by 100000)", "Income (Scaled by 100000)","IRR","DAC Proportion", "Percent of On-bill Financing","Population (Scaled by 100000)"), omit.stat=c("LL","ser","f"), no.space=TRUE)
```
```{r, counties regression}
#final regression picks KWH
...
```{r}
#t tests to compare means of irr in top and bottom
t.test(countiesfbottomq_budget$irr, countiesftopq_budget$irr, na.action=na.omit, var.equal = TRUE) #super sig--> makes sense because only real significance in regression
t.test(countiesfbottomq_energy$irr, countiesftopq_energy$irr, na.action=na.omit) #significant

#t tests to compare means of total revenue in top and bottom
t.test(countiesfbottomq_budget$revenue, countiesftopq_budget$revenue) #significant
t.test(countiesfbottomq_energy$revenue, countiesftopq_energy$revenue) #not significant

#t tests to compare means of population in top and bottom
t.test(countiesfbottomq_budget$population, countiesftopq_budget$population) #significant
t.test(countiesfbottomq_energy$population, countiesftopq_energy$population) #not significant, not different 

#t tests to compare means of dac proportion in top and bottom
t.test(countiesfbottomq_budget$dac, countiesftopq_budget$dac, var.equal = TRUE) #not significant--> not significant in regressions
t.test(countiesfbottomq_energy$dac, countiesftopq_energy$dac, var.equal = TRUE) #not significant

#t tests to compare means of ces score median in top and bottom
t.test(countiesfbottomq_budget$ces_score, countiesftopq_budget$ces_score, var.equal = TRUE) #not significant --> makes sense because not significant with budget in regression
t.test(countiesfbottomq_energy$ces_score, countiesftopq_energy$ces_score) #not significant

#t tests to compare means of mean income in top and bottom
t.test(countiesfbottomq_budget$income, countiesftopq_budget$income, var.equal = TRUE) #not sig --> makes sense because not significant in any of the regressions
t.test(countiesfbottomq_energy$income, countiesftopq_energy$income, var.equal = TRUE) #not sig --> makes sense because not significant in any of the regressions
```

```{r}
#look at average percentage of certain demographics within top and bottom quantile based on budget per cap
t.test(countiesfbottomq_budget$perc_wa,countiesftopq_budget$perc_wa, var.equal = TRUE)

t.test(countiesfbottomq_budget$perc_ba, countiesftopq_budget$perc_ba, var.equal = TRUE)

t.test(countiesfbottomq_budget$perc_aa, countiesftopq_budget$perc_aa, var.equal = TRUE)

t.test(countiesfbottomq_budget$perc_ia, countiesftopq_budget$perc_ia)

t.test(countiesfbottomq_budget$perc_na, countiesftopq_budget$perc_na, var.equal = TRUE)
```
...
```{r, cities scatterplot}
plot.cities_y <- data.frame(cities_x$kWh, cities_x$budget, cities_x$revenue, cities_x$revenue_scaled, cities_x$revpercapita, cities_x$revpercapita_scaled, cities_x$income, cities_x$income_scaled, cities_x$population_scaled, cities_x$population) 
...
stepAIC(lm(ln_budget ~ revenue_scaled + revpercapita_scaled + ruca + dac + population_scaled + obf + income_scaled + resource, data = cities_x))

#ln_budget ~ revenue_scaled + obf + resource, data = cities_x)
#ln_budgetpercapita ~ revenue_scaled + revpercapita_scaled + ruca + population_scaled + obf + resource, data = cities_x)
```

```{r, City Step AIC selection}

#performs stepwise model selection by AIC for kWh
stepAIC(lm(ln_kWh ~ revenue_scaled + revpercapita_scaled + ruca + dac + population_scaled + obf + income_scaled + resource, data = cities_x))
...
<<<<<<< HEAD
cities.2 <- glm(ln_budget ~  revenue + obf + resource, data = cities_x)
summary(cities.2) #Step AIC picks
...
summary(cities.8)
=======
cities.2 <- glm(ln_budget ~  revenue_scaled + obf + resource, data = cities_x) #Step AIC picks

cities.4 <- glm(ln_budget ~ revenue_scaled + revpercapita_scaled + ruca + dac + population_scaled + obf + income_scaled + resource, data = cities_x) #intuitive picks

cities.6 <- glm(ln_budgetpercapita ~ revenue_scaled + revpercapita_scaled + ruca + population_scaled + obf + resource, data = cities_x) #Step AIC picks

<<<<<<< HEAD
cities.8 <- glm(ln_budgetpercapita ~ revpercapita_scaled + ruca + population_scaled + obf + resource, data = cities_x) #intuitive picks
>>>>>>> 98a7956963b1883ec3a935a9b6213d4a763a9bdf
=======
cities.8 <- glm(ln_budgetpercapita ~ revenue_scaled + revpercapita_scaled + ruca + dac + population_scaled + obf + income_scaled + resource, data = cities_x) #intuitive picks
>>>>>>> fd626fd1f30587d4f1928bd7f1de9cf74b0a4a0c
...
cities.3 <- glm(ln_kWh ~ revenue_scaled + revpercapita_scaled + ruca + dac + population_scaled + obf + income_scaled + resource, data = cities_x) #intuitive picks

cities.5 <- glm(ln_kWhpercapita ~ revenue_scaled + ruca + dac + population_scaled + obf, data = cities_x) #Step AIC picks

<<<<<<< HEAD
cities.7 <- glm(ln_kWhpercapita ~ revpercapita_scaled + ruca + dac + population_scaled + obf + income_scaled + resource, data = cities_x) #intuitive picks
>>>>>>> 98a7956963b1883ec3a935a9b6213d4a763a9bdf
=======
cities.7 <- glm(ln_kWhpercapita ~ revenue_scaled + revpercapita_scaled + ruca + dac + population_scaled + obf + income_scaled + resource, data = cities_x) #intuitive picks
>>>>>>> fd626fd1f30587d4f1928bd7f1de9cf74b0a4a0c
...
stargazer(cities.2, cities.4, cities.6, cities.8, type="text", title="Budget Regression Results (Cities)", align=TRUE, dep.var.labels=c("Log of Budget", "Log Budget Per Capita"), order=c("revenue_scaled","revpercapita_scaled", "income_scaled", "ruca", "dac", "obf", "resource", "population_scaled"), covariate.labels=c("Revenue (Scaled by 100000)", "Revenue per Capita (Scaled by 100000)","Income (Scaled by 100000)", "RUCA","DAC Proportion", "Percent of On-bill Financing","Percent of Resource Programs", "Population (Scaled by 100000)"), omit.stat=c("LL","ser","f"), no.space=TRUE)
```
```{r, cities regression}
#final regression picks KWH

stargazer(cities.1, cities.3, cities.5, cities.7, type="text", title="Energy Savings Regression Results (Cities)", align=TRUE, dep.var.labels=c("Log of kWh", "Log kWh Per Capita"), order=c("revenue_scaled","revpercapita_scaled", "income_scaled", "ruca", "dac", "obf", "resource", "population_scaled"), covariate.labels=c("Revenue (Scaled by 100000)", "Revenue per Capita (Scaled by 100000)","Income (Scaled by 100000)", "RUCA","DAC Proportion", "Percent of On-bill Financing","Percent of Resource Programs", "Population (Scaled by 100000)"), omit.stat=c("LL","ser","f"), no.space=TRUE)
```
```{r, cities subsetting}
#Create quantiles of budget
