...
stargazer(K12.2, K12.4, K12.6, K12.8, type="text", title="Budget Regression Results (K12)", align=TRUE, dep.var.labels=c("Log of Budget", "Log Budget Per Student"), order=c("perc_eligible_frpm", "perc_title1", "perc_eligible_free", "lcff", "lcffperstudent", "income", "irr", "dac", "obf"), covariate.labels=c("Percent Eligible for Free or Reduced Meal Plan","Percent of Title 1 Schools", "LCFF","LCFF per student","Income", "IRR","DAC Proportion", "Percent of On-bill Financing"), omit.stat=c("LL","ser","f"), no.space=TRUE)
```
```{r, K12 regression}
#final regression picks KWH

stargazer(K12.1, K12.3, K12.5, K12.7, type="text", title="Energy Savings Regression Results (K12)", align=TRUE, dep.var.labels=c("Log of kWh", "Log kWh Per Student"), order=c("perc_eligible_frpm", "perc_title1", "perc_eligible_free", "lcff", "lcffperstudent", "income", "irr", "dac", "obf"), covariate.labels=c("Percent Eligible for Free or Reduced Meal Plan","Percent of Title 1 Schools", "LCFF","LCFF per student","Income", "IRR","DAC Proportion", "Percent of On-bill Financing"), omit.stat=c("LL","ser","f"), no.space=TRUE)
```
```{r, K12 subsetting}
...
#scaling
counties$rev_scale <- counties$revenue/10000
counties$pop_scale <- counties$population/10000
```
...
counties.6 <- glm(ln_budgetpercapita ~ revpercapita + pop_scale + obf + income, data = counties_x) #Step AIC picks
...
counties.5 <- glm(ln_kWhpercapita ~ revpercapita + pop_scale + income, data = counties_x) #Step AIC picks
...
stargazer(counties.2, counties.4, counties.6, counties.8, type="text", title="Budget Regression Results (County)", align=TRUE, dep.var.labels=c("Log of Budget", "Log Budget Per Capita"), order=c("revenue", "revpercapita", "income", "irr", "dac", "obf", "pop_scale", "population"), covariate.labels=c("Revenue","Revenue per Capita","Income", "IRR","DAC Proportion", "Percent of On-bill Financing","Population (Scaled)", "Population"), omit.stat=c("LL","ser","f"), no.space=TRUE)
```
```{r, counties regression}
#final regression picks KWH

stargazer(counties.1, counties.3, counties.5, counties.7, type="text", title="Energy Savings Regression Results (County)", align=TRUE, dep.var.labels=c("Log of kWh", "Log kWh Per Capita"), order=c("revenue", "revpercapita", "income", "irr", "dac", "obf", "pop_scale", "population"), covariate.labels=c("Revenue", "Revenue per Capita","Income", "IRR","DAC Proportion", "Percent of On-bill Financing","Population (Scaled)", "Population"), omit.stat=c("LL","ser","f"), no.space=TRUE)
```
```{r, counties subsetting}
...
#scaling
cities$pop_scale <- cities$population/10000
```
...
cities.6 <- glm(ln_budgetpercapita ~ revpercapita + ruca + pop_scale + obf + resource, data = cities_x) #Step AIC picks
...
stargazer(cities.2, cities.4, cities.6, cities.8, type="text", title="Budget Regression Results (Cities)", align=TRUE, dep.var.labels=c("Log of Budget", "Log Budget Per Capita"), order=c("revenue","revpercapita", "income", "ruca", "dac", "obf", "resource", "pop_scale"), covariate.labels=c("Revenue", "Revenue per Capita","Income", "RUCA","DAC Proportion", "Percent of On-bill Financing","Percent of Resource Programs", "Population (Scaled)"), omit.stat=c("LL","ser","f"), no.space=TRUE)
```
```{r, cities regression}
#final regression picks KWH

stargazer(cities.1, cities.3, cities.5, cities.7, type="text", title="Energy Savings Regression Results (Cities)", align=TRUE, dep.var.labels=c("Log of kWh", "Log kWh Per Capita"), order=c("revenue","revpercapita", "income", "ruca", "dac", "obf", "resource", "pop_scale"), covariate.labels=c("Revenue","Revenue per Capita","Income", "RUCA","DAC Proportion", "Percent of On-bill Financing", "Percent of Resource Programs","Population (1000)"), omit.stat=c("LL","ser","f"), no.space=TRUE)
```
```{r, cities subsetting}
#Create quantiles of budget
