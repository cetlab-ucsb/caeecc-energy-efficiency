...
#performs stepwise model selection by AIC for budget
stepAIC(lm(ln_budget ~ revenue + dac + irr + population + obf + income, data = counties_x))
...
#performs stepwise model selection by AIC for kWh
stepAIC(lm(ln_kWh ~ revenue + dac + irr + population + obf + income , data = counties_x))
...
counties.2 <- glm(ln_budget ~  irr, data = counties_x) #Step AIC picks

counties.4 <- glm(ln_budget ~ revenue + dac + irr + obf + income, data = counties_x) #intuitive picks
...
counties.1 <- glm(ln_kWh ~  irr + population, data = counties_x) #Step AIC picks

counties.3 <- glm(ln_kWh ~ revenue + dac + irr + obf + income, data = counties_x) #intuitive picks
