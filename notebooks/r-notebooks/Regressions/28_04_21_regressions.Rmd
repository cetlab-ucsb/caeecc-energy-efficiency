...
```{r}
#t tests on different quantiles for budget
t.test(counties_lnq1$Budget, counties_lnq2$Budget)
t.test(counties_lnq2$Budget, counties_lnq3$Budget)
t.test(counties_lnq3$Budget, counties_lnq4$Budget)
t.test(counties_lnq1$Budget, counties_lnq3$Budget)
t.test(counties_lnq1$Budget, counties_lnq4$Budget)
t.test(counties_lnq2$Budget, counties_lnq4$Budget)

#t tests on different quantiles for energy savings
t.test(counties_lnq1$TotalFirstYearGrosskWh, counties_lnq2$TotalFirstYearGrosskWh)
t.test(counties_lnq1$TotalFirstYearGrosskWh, counties_lnq3$TotalFirstYearGrosskWh)
t.test(counties_lnq1$TotalFirstYearGrosskWh, counties_lnq4$TotalFirstYearGrosskWh)
t.test(counties_lnq2$TotalFirstYearGrosskWh, counties_lnq3$TotalFirstYearGrosskWh)
t.test(counties_lnq2$TotalFirstYearGrosskWh, counties_lnq4$TotalFirstYearGrosskWh)
t.test(counties_lnq3$TotalFirstYearGrosskWh, counties_lnq4$TotalFirstYearGrosskWh)
```
