...
cities_full <- read.csv("cities_3.csv")
...
t.test(budget_percap_lq$proportion.Asian.alone, budget_percap_uq$proportion.Asian.alone)
t.test(budget_percap_lq$proportion.American.Indian.and.Alaska.Native.alone, budget_percap_uq$proportion.American.Indian.and.Alaska.Native.alone)
t.test(budget_percap_lq$proportion.Native.Hawaiian.and.Other.Pacific.Islander.alone, budget_percap_uq$proportion.Native.Hawaiian.and.Other.Pacific.Islander.alone)
...
t.test(fyg_percap_lq$total_population, fyg_percap_uq$total_population)
t.test(fyg_percap_lq$proportion.Black.or.African.American.alone, fyg_percap_uq$proportion.Black.or.African.American.alone)
t.test(fyg_percap_lq$total_population, fyg_percap_uq$total_population)
t.test(fyg_percap_lq$Total.Tax.Revenue, fyg_percap_uq$Total.Tax.Revenue)
t.test(fyg_percap_lq$proportion.White.alone, fyg_percap_uq$proportion.White.alone)
t.test(fyg_percap_lq$proportion.Asian.alone, fyg_percap_uq$proportion.Asian.alone)
t.test(fyg_percap_lq$proportion.American.Indian.and.Alaska.Native.alone, fyg_percap_uq$proportion.American.Indian.and.Alaska.Native.alone)
t.test(fyg_percap_lq$proportion.Native.Hawaiian.and.Other.Pacific.Islander.alone, fyg_percap_uq$proportion.Native.Hawaiian.and.Other.Pacific.Islander.alone)
