...
```
```{r}
#one with tax rev no population and opposite
...
bottom_omit = na.omit(bottomq_budget)
top_omit = na.omit(topq_budget)

mean(bottom_omit$taxrev_per_cap)
mean(top_omit$taxrev_per_cap)
